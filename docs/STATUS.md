...
| **Milestone now** | **Milestone 1 closed.** Next coding: **Milestone 2 — monthly memory** |
...
| **Milestone** | What we actually build next | [MILESTONE-1.md](./MILESTONE-1.md), then Milestone 2 |
...
| 16 | Come back and see history | Thin — snapshots exist; M2 makes months readable |
...
**Milestone 2 — monthly memory** (coding now):

See the months. A close for each remembered month: what came in, what went out, what stayed, in one quiet list — not a spreadsheet, not a new tab.
